...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public struct HDShadowInitParameters
    {
        ...
        public static readonly HDShadowInitParameters @default = new HDShadowInitParameters()
        {
            ...
            shadowResolutionDirectional         = new IntScalableSetting { low = 256, med = 512, high = 1024 },
            shadowResolutionArea                = new IntScalableSetting { low = 256, med = 512, high = 1024 },
            shadowResolutionPunctual            = new IntScalableSetting { low = 256, med = 512, high = 1024 },
