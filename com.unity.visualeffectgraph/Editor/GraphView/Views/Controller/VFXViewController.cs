    ...
    internal partial class VFXViewController : Controller<VisualEffectResource>
    {
        ...
        public void UpdateSystems()
        {
            try
            {
                ...
                var systemTitles = new List<string>();
                foreach (var sys in m_Systems)
                    systemTitles.Add(sys.title);
                ...
                for (int i = 0; i < systems.Count(); ++i)
                {
                    ...
                    var systemTitle = graph.UIInfos.GetNameOfSystem(systems[i].Keys, systemTitles);
                    m_Systems[i].title = systemTitle;
