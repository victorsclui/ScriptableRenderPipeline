...
namespace UnityEditor.VFX.Test
{
    ...
    public class VFXControllersTests
    {
        ...
        public void UniqueSpawnersNames()
        {
            ...
            var contextUITextField = VFXTestCommon.GetFieldValue<VFXContextUI, TextField>(UIElts[0], "m_TextField");
            contextUITextField.value = name;
            foreach (var contextUI in UIElts)
            {
                VFXTestCommon.SetFieldValue(contextUI, "m_TextField", contextUITextField);
                VFXTestCommon.CallMethod(contextUI, "OnTitleBlur", new object[] { null });
            }
